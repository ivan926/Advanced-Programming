...
public class Person {
     ...
     */
    private String gender = null; //use enumerator for just f or m characters/strings
    /**
     * The ID of this persons Father / or NULL
     */
    private String fatherID = null; //can be null
    /**
     * The ID of this persons Mother / or NULL
     */
    private String motherID = null; //can be null
    /**
     * The ID of this persons Spouse / or NULL
     */
    private String spouseID = null; //can be null
