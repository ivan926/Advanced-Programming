...
public class PersonHandler extends Handler{
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        Gson gson = new Gson();
        System.out.println("Receiving person Request");
        ...
        try {
            ...
            if (exchange.getRequestMethod().toLowerCase().equals("get")) {
                ...
                System.out.println(reqHeaders.getFirst("Authorization"));
               if( reqHeaders.containsKey("Authorization") ) {
                   ...
                   if( !authToken.equals( authtoken.getAuthToken()) )
                   {
                       ...
                       {
                           personRequest = new PersonRequest(false,authtoken);
                       }
                       else {
                           personRequest = new PersonRequest(secondParameter, true,authtoken);
                       }

                       PersonService service = new PersonService();
                       PersonResponse result = service.person(personRequest);
            ...
            if (!success) {
                ...
                PersonResponse personResponse = new PersonResponse("Error: Incorrect auth token");
